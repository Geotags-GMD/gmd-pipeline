...
#            feedback.pushInfo(f"Could not set output layer completion name: {str(e)}")
        ...
        feedback.pushInfo(f"[DIAGNOSTIC] Total delineation candidates identified in Phase 2: {len(delineation_candidate_eans)}")
        feedback.pushInfo(f"[DIAGNOSTIC] Total merge candidates identified in Phase 2: {len(merge_candidate_eans)}")
