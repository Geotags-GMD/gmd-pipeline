...
<qgis version="2.6.1-Brighton" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="GEOCODE">
      <widgetv2config IsMultiline="0" fieldEditable="1" UseHtml="0" labelOnTop="0"/>
    </edittype>
  ...
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules key="{d4165e2e-cb7a-40eb-a3d0-25542c933394}">
      <rule scalemaxdenom="5000" key="{0a27df65-eab6-40ab-889f-dd50b2f738cf}" symbol="0" label="Railway (Large)"/>
      <rule scalemaxdenom="20000" key="{08efafd7-30ed-4ff5-b9e4-938046c8af50}" symbol="1" scalemindenom="5000" label="Railway (Medium)"/>
      <rule scalemaxdenom="40000" key="{df326e3c-663f-4d3c-b09c-054ea9950af7}" symbol="2" scalemindenom="20000" label="Railway (Small)"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="104,104,104,255"/>
      ...
      <symbol alpha="1" type="line" name="2">
        <layer pass="0" class="SimpleLine" locked="0">
          ...
          <prop k="line_color" v="104,104,104,255"/>
          <prop k="line_style" v="solid"/>
          <prop k="line_width" v="0.07"/>
          <prop k="line_width_unit" v="MM"/>
          <prop k="offset" v="-0.55"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
          <prop k="offset_unit" v="MM"/>
          <prop k="use_custom_dash" v="0"/>
          <prop k="width_map_unit_scale" v="0,0"/>
